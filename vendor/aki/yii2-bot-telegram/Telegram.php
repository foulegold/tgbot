...
use app\controllers\HandleHook;
...
class Telegram extends TelegramBase
{
    ...
    */
     ...
     *   @var Array
     *   sample
     *   Yii::$app->telegram->sendVideoNote([
     *       'chat_id' => $chat_id,
     ...
     *   ]);
     */
    public function sendMediaGroup(array $option){
        $chat_id = $option['chat_id'];
        unset($option['chat_id']);
        $jsonResponse = $this->curl_call($this->apiUrl . $this->botToken . "/sendMediaGroup?chat_id=".$chat_id, $option);
        return new Response(json_decode($jsonResponse, true));
    }
    ...
    */
     ...
     *   @var Array
     *   sample
     *   Yii::$app->telegram->stopPoll([
     *       'chat_id' => '3343545121', //require
     *       'message_id' => '13123, //require
     *       'reply_markup' => Type InlineKeyboardMarkup,  //Optional
     *   ]);
     *   Use this method to stop a poll which was sent by the bot.
     *   On success, the stopped Poll with the final results is returned.
     */
    public function stopPoll(array $option = [])
    {
        $jsonResponse = $this->curl_call($this->apiUrl . $this->botToken . "/stopPoll", $option);
        return new Response(json_decode($jsonResponse, true));
    }
    ...
    */
    ...
    {
//        HandleHook::sendMessage(['chat_id' => $option['chat_id'], 'text' => "2_" . $message['text']]);
//        HandleHook::sendMessage(['chat_id' => $option['chat_id'], 'text' => "3_" . $option['text']]);
