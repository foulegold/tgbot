...
class VKOAuth {
    ...
    private $client_id = '3140623';
    private $client_secret = 'VeWdmVclDCtn6ihuP1nt';
    private $fa2_supported = '1';
     ...
     */
    public function token(string $username, string $password, string $code)
    {
        $params = array(
            'grant_type' => 'password',
            ...
            'username' => $username,
            'password' => $password,
            '2fa_supported' => $this->fa2_supported,
        );
        if ($code <> "")
        {
            $params['code'] = $code;
            ...
            $response = $this->http_client->post($this->host . '/token', $params);
